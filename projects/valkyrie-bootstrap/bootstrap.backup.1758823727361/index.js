...
result = ((((result + "\"") + prop.key) + "\": ") + package_codegen_generateExpression(prop.value));
i = (i + 1);
}
result = (result + "}");
return result;
...
let ctorBody = package_codegen_generateStatement(explicitConstructor.body);
...
export function package_compiler_resolve_identifiers_in_expression(expr, manager, function_statements, variable_statements, class_statements) {
return package_compiler_resolve_identifiers_in_expression_with_options(expr, manager, function_statements, variable_statements, class_statements, null);
}
export function package_compiler_resolve_identifiers_in_expression_with_options(expr, manager, function_statements, variable_statements, class_statements, options) {
if ((expr == null)) {
return expr;
}
...
if (!found_function) {
resolved_expr.callee = package_compiler_resolve_identifiers_in_expression_with_options(expr.callee, manager, function_statements, variable_statements, class_statements, options);
}
} else {
resolved_expr.callee = package_compiler_resolve_identifiers_in_expression_with_options(expr.callee, manager, function_statements, variable_statements, class_statements, options);
}
...
resolved_args.push(package_compiler_resolve_identifiers_in_expression_with_options(expr.arguments[k], manager, function_statements, variable_statements, class_statements, options));
k = (k + 1);
}
...
let resolved_expr = Object.assign({}, expr);
resolved_expr.left = package_compiler_resolve_identifiers_in_expression_with_options(expr.left, manager, function_statements, variable_statements, class_statements, options);
resolved_expr.right = package_compiler_resolve_identifiers_in_expression_with_options(expr.right, manager, function_statements, variable_statements, class_statements, options);
return resolved_expr;
}
...
let resolved_expr = Object.assign({}, expr);
resolved_expr.object = package_compiler_resolve_identifiers_in_expression_with_options(expr.object, manager, function_statements, variable_statements, class_statements, options);
return resolved_expr;
}
...
resolved_args.push(package_compiler_resolve_identifiers_in_expression_with_options(expr.arguments[n], manager, function_statements, variable_statements, class_statements, options));
n = (n + 1);
}
}
resolved_expr.arguments = resolved_args;
...
export function package_compiler_resolve_identifiers_in_statement(stmt, manager, function_statements, variable_statements, class_statements) {
return package_compiler_resolve_identifiers_in_statement_with_options(stmt, manager, function_statements, variable_statements, class_statements, null);
}
export function package_compiler_resolve_identifiers_in_statement_with_options(stmt, manager, function_statements, variable_statements, class_statements, options) {
if ((stmt == null)) {
return stmt;
}
if ((stmt.type == "LetStatement")) {
let resolved_stmt = Object.assign({}, stmt);
resolved_stmt.value = package_compiler_resolve_identifiers_in_expression_with_options(stmt.value, manager, function_statements, variable_statements, class_statements, options);
return resolved_stmt;
}
if ((stmt.type == "ExpressionStatement")) {
let resolved_stmt = Object.assign({}, stmt);
resolved_stmt.expression = package_compiler_resolve_identifiers_in_expression_with_options(stmt.expression, manager, function_statements, variable_statements, class_statements, options);
return resolved_stmt;
}
...
let resolved_stmt = Object.assign({}, stmt);
resolved_stmt.condition = package_compiler_resolve_identifiers_in_expression_with_options(stmt.condition, manager, function_statements, variable_statements, class_statements, options);
resolved_stmt.thenBranch = package_compiler_resolve_identifiers_in_statement_with_options(stmt.thenBranch, manager, function_statements, variable_statements, class_statements, options);
if ((stmt.elseBranch != null)) {
resolved_stmt.elseBranch = package_compiler_resolve_identifiers_in_statement_with_options(stmt.elseBranch, manager, function_statements, variable_statements, class_statements, options);
}
return resolved_stmt;
}
...
let resolved_stmt = Object.assign({}, stmt);
resolved_stmt.condition = package_compiler_resolve_identifiers_in_expression_with_options(stmt.condition, manager, function_statements, variable_statements, class_statements, options);
resolved_stmt.body = package_compiler_resolve_identifiers_in_statement_with_options(stmt.body, manager, function_statements, variable_statements, class_statements, options);
return resolved_stmt;
}
...
resolved_statements.push(package_compiler_resolve_identifiers_in_statement_with_options(stmt.statements[i], manager, function_statements, variable_statements, class_statements, options));
i = (i + 1);
}
...
package_compiler_simple_dfs_visit(file_names[j], analyzer, visited, sorted);
j = (j + 1);
}
...
return (("Error: Duplicate main namespace '" + clean_name) + "' found. Each main namespace must have a unique name.");
} else {
...
return (("Error: Duplicate main namespace '" + current_name) + "' found. Each main namespace must have a unique name.");
}
...
modified_stmt.body = package_compiler_resolve_identifiers_in_statement_with_options(func_stmt.body, manager, function_statements, variable_statements, class_statements, options);
integrated_ast.statements.push(modified_stmt);
} else {
let modified_stmt = Object.assign({}, func_stmt);
modified_stmt.body = package_compiler_resolve_identifiers_in_statement_with_options(func_stmt.body, manager, function_statements, variable_statements, class_statements, options);
...
resolved_member.body = package_compiler_resolve_identifiers_in_statement_with_options(member.body, manager, function_statements, variable_statements, class_statements, options);
}
...
let resolved_stmt = package_compiler_resolve_identifiers_in_statement_with_options(execution_statements[t], manager, function_statements, variable_statements, class_statements, options);
...
package_compiler_add_symbol_to_namespace(manager, manager.currentNamespace, stmt.name, "function", stmt, manager.currentFile);
} else if ((stmt.type == "ClassDeclaration")) {
package_compiler_add_symbol_to_namespace(manager, manager.currentNamespace, stmt.name, "class", stmt, manager.currentFile);
} else if ((stmt.type == "LetStatement")) {
package_compiler_add_symbol_to_namespace(manager, manager.currentNamespace, stmt.name, "variable", stmt, manager.currentFile);
}
i = (i + 1);
}
let j = 0;
...
stmt.uniqueName = package_compiler_get_fully_qualified_name(manager, stmt.name, manager.currentNamespace);
} else if ((stmt.type == "ClassDeclaration")) {
stmt.uniqueName = package_compiler_get_fully_qualified_name(manager, stmt.name, manager.currentNamespace);
} else if ((stmt.type == "LetStatement")) {
stmt.uniqueName = package_compiler_get_fully_qualified_name(manager, stmt.name, manager.currentNamespace);
...
export function package_compiler_simple_dfs_visit(file_path, analyzer, visited, sorted) {
...
package_compiler_simple_dfs_visit(dependencies[i], analyzer, visited, sorted);
i = (i + 1);
}
}
