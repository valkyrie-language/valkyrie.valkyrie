...
export function package_parser_parseExpressionWithPrecedence(parser, minPrecedence) {
...
let right = package_parser_parseExpressionWithPrecedence(parser, nextMinPrecedence);
